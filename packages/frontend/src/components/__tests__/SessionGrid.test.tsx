...
describe('SessionGrid', () => {
  it('renders all sessions as cards', () => {
    ...
    render(<SessionGrid sessions={sessions} onSelect={vi.fn()} selectedId={null} />);
  ...
  it('renders empty state placeholder when sessions list is empty', () => {
    render(<SessionGrid sessions={[]} onSelect={vi.fn()} selectedId={null} />);
  ...
  it('calls onSelect with the correct sessionId when a card is clicked', () => {
    ...
    render(<SessionGrid sessions={sessions} onSelect={onSelect} selectedId={null} />);
