 ...
 *  8. Forbidden actions
 *  9. Git isolation
 * 10. Separator + "# Project Instructions (from project CLAUDE.md)" (added by caller)
 */
...
- **Command**: \`gh pr create --draft --base ${targetBranch} --body-file /tmp/pr-body.md\`
...
- The backend records the main repo branch before each session and will warn if it drifts`.trimEnd();
}
