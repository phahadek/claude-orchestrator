...
export const GATE_ITEM_TIER_DESCRIPTIONS: Record<
  ...
  string
> = {
  'Read-Only': 'A check that reads state without changing it — a query, a ' +
  ...
  'needs-triage': 'The classification is genuinely unknown and must be ' +
