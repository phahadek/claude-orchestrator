...
const STOPWORDS = new Set([
  'the', 'a', 'an', 'and', 'or', 'but', 'for', 'with', 'without', 'into',
  'from', 'that', 'this', 'these', 'those', 'when', 'where', 'which', 'who',
  'what', 'how', 'why', 'not', 'never', 'always', 'each', 'every', 'per',
  'its', 'it', 'is', 'are', 'was', 'were', 'be', 'been', 'being', 'to', 'of',
  'in', 'on', 'at', 'by', 'as', 'if', 'then', 'than', 'so', 'do', 'does',
  'did', 'has', 'have', 'had', 'will', 'would', 'should', 'could', 'can',
  'must', 'may', 'might', 'task', 'tasks', 'design', 'code',
]);
