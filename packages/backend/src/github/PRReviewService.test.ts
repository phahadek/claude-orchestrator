...
describe('PRReviewService.reReviewPR()', () => {
  ...
  it('includes an Orchestrator-Verified Test Run section in the follow-up when a finished run exists for the session', async () => {
    const prRowWithSession = {
      ...mockPRRow,
      review_session_id: 'existing-review-session-abc',
      session_id: 'session-xyz',
  ...
  it('omits the Orchestrator-Verified Test Run section from the follow-up when no finished run exists for the session', async () => {
    const prRowWithSession = {
      ...mockPRRow,
      review_session_id: 'existing-review-session-abc',
      session_id: 'session-xyz',
